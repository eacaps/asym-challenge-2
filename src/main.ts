import AutocompleteProvider from "./trainer/autocompleteprovider";
...
const prompt_validator = new RegExp(
  train_pattern + "|" + input_pattern + "|" + exit_pattern
);
...
const run_prompt = () => {
  ...
  Prompt.get(prompt_properties, function (err: any, result: any) {
